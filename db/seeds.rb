...
Product.destroy_all
Product.create! id: 1, name: "Surgical Stent with Implant Guide", price: 120, image_url: "../img/stent_guide.jpg", alt_image: "../img/stent_guide2.jpg", active: true
Product.create! id: 2, name: "CBCT", price: 150, image_url: "../img/cbct.jpg", active: true
...
Order.create! id: 3, order_status_id: 1, dentist_id: 1, patient_name: "Bao-Chau Nguyen"
